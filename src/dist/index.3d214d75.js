...
})({"aMdWs":[function(require,module,exports) {
"use strict";
...
var _vanillaRouter = require("vanilla-router");
var _vanillaRouterDefault = parcelHelpers.interopDefault(_vanillaRouter);
var router = new (0, _vanillaRouterDefault.default)({
    mode: "history",
...
router.add("", function() {
    ...
    fetch(apklrbsiRequest, apklrbsiInit).then((response)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3DQm5","vanilla-router":"8knhe"}],"3DQm5":[function(require,module,exports) {
...
},{}],"8knhe":[function(require,module,exports) {
(function(global, factory) {
     ...
     */ Router.prototype._getHistoryFragment = function() {
        ...
        if (this.root !== "/") fragment = fragment.replace(this.root, "");
     ...
     */ Router.prototype._getFragment = function() {
        if (this.mode === "history") return this._getHistoryFragment();
        else return this._getHashFragment();
    };
    /**
     ...
     */ Router.prototype._parseQuery = function(query) {
        var _query = {};
        if (typeof query !== "string") return _query;
        if (query[0] === "?") query = query.substr(1);
        this._queryString = query;
        query.split("&").forEach(function(row) {
            var parts = row.split("=");
            if (parts[0] !== "") {
                if (parts[1] === undefined) parts[1] = true;
     ...
     */ Router.prototype._getQuery = function() {
        if (this.mode === "history") return this._getHistoryQuery();
        else return this._getHashQuery();
    };
    /**
     ...
     */ Router.prototype.remove = function(param) {
        var _this = this;
        if (typeof param === "string") param = this._parseRouteRule(param).toString();
     ...
     */ Router.prototype._pushHistory = function() {
        ...
        if (this.mode === "hash") {
            if (this._historyState === "add") {
                if (this._historyIdx !== this._historyStack.length - 1) this._historyStack.splice(this._historyIdx + 1);
     ...
     */ Router.prototype._unloadCallback = function(asyncRequest) {
        var result;
        if (this._skipCheck) return asyncRequest ? Promise.resolve(true) : true;
        if (this._currentPage && this._currentPage.options && this._currentPage.options.unloadCb) {
            ...
            if (!asyncRequest || result instanceof Promise) return result;
            return result ? Promise.resolve(result) : Promise.reject(result);
        } else return asyncRequest ? Promise.resolve(true) : true;
    };
    /**
     ...
     */ Router.prototype._findRoute = function() {
        ...
        return this.routes.some(function(route) {
            ...
            if (match) {
                ...
                if (!_this.securityHook(page)) return false;
                ...
                window.onbeforeunload = function(ev) {
                    if (_this._unloadCallback(false)) return;
                    ev.returnValue = true;
                    return true;
                };
                return true;
     ...
     */ Router.prototype._treatAsync = function() {
        ...
        if (!(result instanceof Promise)) result = result ? Promise.resolve(result) : Promise.reject(result);
     ...
     */ Router.prototype._processUri = function() {
        ...
        if (!found) this._page404(fragment);
    };
    /**
     ...
     */ Router.prototype.check = function() {
        ...
        if (this._currentPage && this._currentPage.options && this._currentPage.options.unloadCb) this._treatAsync();
        else this._processUri();
        return this;
    };
    /**
     ...
     */ Router.prototype.addUriListener = function() {
        if (this.mode === "history") window.onpopstate = this.check.bind(this);
        else window.onhashchange = this.check.bind(this);
        return this;
    };
    /**
...
},{}]},["aMdWs","bB7Pu"], "bB7Pu", "parcelRequire94c2")
